...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="AN or fuzzy match on analyse" exec="{project-root}/_bmad/core/workflows/analysis/workflow.md">[AN] Analyse the whole project structure and provide comprehensive analysis</item>
